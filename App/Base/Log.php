...
abstract class Log implements ActiveRecordInterface
{
    ...
    public function setLog($v)
    {
        ...
        if ($this->log !== $v) {
            $this->log = $v;
            $this->modifiedColumns[LogTableMap::COL_LOG] = true;
        }
    ...
    public function setClienteId($v)
    {
        ...
        if ($this->cliente_id !== $v) {
            $this->cliente_id = $v;
            $this->modifiedColumns[LogTableMap::COL_CLIENTE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LogTableMap::translateFieldName('Log', TableMap::TYPE_PHPNAME, $indexType)];
            $this->log = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LogTableMap::translateFieldName('ClienteId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = LogTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LogTableMap::COL_LOG)) {
            $modifiedColumns[':p' . $index++]  = 'log';
        }
        if ($this->isColumnModified(LogTableMap::COL_CLIENTE_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogTableMap::COL_LOG)) {
            $criteria->add(LogTableMap::COL_LOG, $this->log);
        }
        if ($this->isColumnModified(LogTableMap::COL_CLIENTE_ID)) {
            $criteria->add(LogTableMap::COL_CLIENTE_ID, $this->cliente_id);
        }
