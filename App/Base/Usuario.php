...
abstract class Usuario implements ActiveRecordInterface
{
    ...
    public function setPermissao($v)
    {
        ...
        if ($this->permissao !== $v) {
            $this->permissao = $v;
            $this->modifiedColumns[UsuarioTableMap::COL_PERMISSAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsuarioTableMap::translateFieldName('Permissao', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_PERMISSAO)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_PERMISSAO)) {
            $criteria->add(UsuarioTableMap::COL_PERMISSAO, $this->permissao);
        }
