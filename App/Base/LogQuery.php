 ...
 * @method     ChildLogQuery orderByLog($order = Criteria::ASC) Order by the log column
 * @method     ChildLogQuery orderByClienteId($order = Criteria::ASC) Order by the cliente_id column
 *
 * @method     ChildLogQuery groupById() Group by the id column
 * @method     ChildLogQuery groupByData() Group by the data column
 * @method     ChildLogQuery groupByLog() Group by the log column
 * @method     ChildLogQuery groupByClienteId() Group by the cliente_id column
 *
 ...
 *
 * @method     ChildLogQuery leftJoinCliente($relationAlias = null) Adds a LEFT JOIN clause to the query using the Cliente relation
 * @method     ChildLogQuery rightJoinCliente($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Cliente relation
 * @method     ChildLogQuery innerJoinCliente($relationAlias = null) Adds a INNER JOIN clause to the query using the Cliente relation
 *
 * @method     ChildLogQuery joinWithCliente($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Cliente relation
 *
 * @method     ChildLogQuery leftJoinWithCliente() Adds a LEFT JOIN clause and with to the query using the Cliente relation
 * @method     ChildLogQuery rightJoinWithCliente() Adds a RIGHT JOIN clause and with to the query using the Cliente relation
 * @method     ChildLogQuery innerJoinWithCliente() Adds a INNER JOIN clause and with to the query using the Cliente relation
 *
 ...
 * @method     ChildLog findOneByLog(string $log) Return the first ChildLog filtered by the log column
 * @method     ChildLog findOneByClienteId(int $cliente_id) Return the first ChildLog filtered by the cliente_id column *
 ...
 * @method     ChildLog requireOneByLog(string $log) Return the first ChildLog filtered by the log column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildLog requireOneByClienteId(int $cliente_id) Return the first ChildLog filtered by the cliente_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildLog[]|ObjectCollection findByLog(string $log) Return ChildLog objects filtered by the log column
 * @method     ChildLog[]|ObjectCollection findByClienteId(int $cliente_id) Return ChildLog objects filtered by the cliente_id column
...
abstract class LogQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, data, log, cliente_id FROM log WHERE id = :p0';
        try {
    ...
    public function filterByLog($log = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LogTableMap::COL_LOG, $log, $comparison);
    }
    ...
    public function filterByClienteId($clienteId = null, $comparison = null)
    {
        if (is_array($clienteId)) {
            ...
            if (isset($clienteId['min'])) {
                $this->addUsingAlias(LogTableMap::COL_CLIENTE_ID, $clienteId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($clienteId['max'])) {
                $this->addUsingAlias(LogTableMap::COL_CLIENTE_ID, $clienteId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(LogTableMap::COL_CLIENTE_ID, $clienteId, $comparison);
    }
    ...
    public function filterByCliente($cliente, $comparison = null)
    {
        if ($cliente instanceof \Cliente) {
            return $this
                ->addUsingAlias(LogTableMap::COL_CLIENTE_ID, $cliente->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(LogTableMap::COL_CLIENTE_ID, $cliente->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
