 ...
 * @method     ChildUsuarioQuery orderByPermissao($order = Criteria::ASC) Order by the permissao column
 *
 ...
 * @method     ChildUsuarioQuery groupByPermissao() Group by the permissao column
 *
 ...
 * @method     ChildUsuario findOneByPermissao(int $permissao) Return the first ChildUsuario filtered by the permissao column *
 ...
 * @method     ChildUsuario requireOneByPermissao(int $permissao) Return the first ChildUsuario filtered by the permissao column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsuario[]|ObjectCollection findByPermissao(int $permissao) Return ChildUsuario objects filtered by the permissao column
...
abstract class UsuarioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, login, senha, permissao FROM usuario WHERE id = :p0';
        try {
    ...
    public function filterByPermissao($permissao = null, $comparison = null)
    {
        if (is_array($permissao)) {
            ...
            if (isset($permissao['min'])) {
                $this->addUsingAlias(UsuarioTableMap::COL_PERMISSAO, $permissao['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($permissao['max'])) {
                $this->addUsingAlias(UsuarioTableMap::COL_PERMISSAO, $permissao['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsuarioTableMap::COL_PERMISSAO, $permissao, $comparison);
    }
