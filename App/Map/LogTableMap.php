...
class LogTableMap extends TableMap
{
     ...
     */
    const COL_LOG = 'log.log';

    /**
     * the column name for the cliente_id field
     */
    const COL_CLIENTE_ID = 'log.cliente_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Data', 'Log', 'ClienteId', ),
        self::TYPE_CAMELNAME     => array('id', 'data', 'log', 'clienteId', ),
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID, LogTableMap::COL_DATA, LogTableMap::COL_LOG, LogTableMap::COL_CLIENTE_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'data', 'log', 'cliente_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Data' => 1, 'Log' => 2, 'ClienteId' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'data' => 1, 'log' => 2, 'clienteId' => 3, ),
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID => 0, LogTableMap::COL_DATA => 1, LogTableMap::COL_LOG => 2, LogTableMap::COL_CLIENTE_ID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'data' => 1, 'log' => 2, 'cliente_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LogTableMap::COL_LOG);
            $criteria->addSelectColumn(LogTableMap::COL_CLIENTE_ID);
        } else {
