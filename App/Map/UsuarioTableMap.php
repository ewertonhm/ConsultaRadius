...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const COL_PERMISSAO = 'usuario.permissao';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Senha', 'Permissao', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'senha', 'permissao', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID, UsuarioTableMap::COL_LOGIN, UsuarioTableMap::COL_SENHA, UsuarioTableMap::COL_PERMISSAO, ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'senha', 'permissao', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Senha' => 2, 'Permissao' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'senha' => 2, 'permissao' => 3, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID => 0, UsuarioTableMap::COL_LOGIN => 1, UsuarioTableMap::COL_SENHA => 2, UsuarioTableMap::COL_PERMISSAO => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'senha' => 2, 'permissao' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_PERMISSAO);
        } else {
